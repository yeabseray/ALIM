...
## -------------------------------------------------------------------------------
Belgium_female_2018 = read.table(file = "~/OneDrive/KU LEUVEN/ALIM//Belgium_female_2018.txt", header = TRUE)

## -------------------------------------------------------------------------------
head(Belgium_female_2018)

## -------------------------------------------------------------------------------
Belgium_male_2018 = read.table(file = "~/OneDrive/KU LEUVEN/ALIM//Belgium_male_2018.txt", header = TRUE)
